...
from educationvdo.filesystem import create_directory, is_directory, is_file, remove_directory
from educationvdo.types import JobStatus
...
def get_test_jobs_directory() -> str:
	return os.path.join(tempfile.gettempdir(), 'educationvdo-test-jobs')
...
def get_test_examples_directory() -> str:
	return os.path.join(tempfile.gettempdir(), 'educationvdo-test-examples')
...
def get_test_outputs_directory() -> str:
	return os.path.join(tempfile.gettempdir(), 'educationvdo-test-outputs')
