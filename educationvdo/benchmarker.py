...
from educationvdo import content_analyser, core, state_manager
from educationvdo.cli_helper import render_table
from educationvdo.download import conditional_download, resolve_download_url
from educationvdo.face_store import clear_faces
from educationvdo.filesystem import get_file_extension
from educationvdo.types import BenchmarkCycleSet
from educationvdo.vision import count_video_frame_total, detect_video_fps
...
def run() -> Iterator[List[BenchmarkCycleSet]]:
	...
	benchmarks = []
	target_paths = [ educationvdo.choices.benchmark_set.get(benchmark_resolution) for benchmark_resolution in benchmark_resolutions if benchmark_resolution in educationvdo.choices.benchmark_set ]
