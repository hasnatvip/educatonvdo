...
def render() -> None:
	...
	EXECUTION_THREAD_COUNT_SLIDER = gradio.Slider(
		...
		step = calculate_int_step(educationvdo.choices.execution_thread_count_range),
		minimum = educationvdo.choices.execution_thread_count_range[0],
		maximum = educationvdo.choices.execution_thread_count_range[-1]
	)
