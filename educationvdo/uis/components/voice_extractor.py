...
from educationvdo import state_manager, translator, voice_extractor
from educationvdo.filesystem import is_video
from educationvdo.types import VoiceExtractorModel
...
def render() -> None:
	...
	VOICE_EXTRACTOR_MODEL_DROPDOWN = gradio.Dropdown(
		...
		choices = educationvdo.choices.voice_extractor_models,
