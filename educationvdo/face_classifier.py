...
from educationvdo import inference_manager
...
from educationvdo.types import Age, DownloadScope, FaceLandmark5, Gender, InferencePool, ModelOptions, ModelSet, Race, VisionFrame
