...
from educationvdo.common_helper import is_macos, is_windows
...
from educationvdo.normalizer import normalize_color
from educationvdo.processors.modules.background_remover import choices as background_remover_choices
from educationvdo.processors.modules.background_remover.types import BackgroundRemoverInputs
...
from educationvdo.types import ApplyStateItem, Args, DownloadScope, InferencePool, InferenceProvider, Mask, ModelOptions, ModelSet, ProcessMode, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		educationvdo.jobs.job_store.register_step_keys([ 'background_remover_model', 'background_remover_fill_color', 'background_remover_despill_color' ])
