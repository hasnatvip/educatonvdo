...
from educationvdo.common_helper import create_int_metavar, get_middle
from educationvdo.download import conditional_download_hashes, conditional_download_sources, resolve_download_url_by_provider
from educationvdo.face_creator import scale_face
...
from educationvdo.filesystem import get_file_name, in_directory, is_image, is_video, resolve_file_paths, resolve_relative_path, same_file_extension
from educationvdo.processors.modules.deep_swapper import choices as deep_swapper_choices
from educationvdo.processors.modules.deep_swapper.types import DeepSwapperInputs, DeepSwapperMorph
from educationvdo.processors.types import ProcessorOutputs
from educationvdo.program_helper import find_argument_group
from educationvdo.thread_helper import thread_semaphore
from educationvdo.types import ApplyStateItem, Args, DownloadScope, Face, InferencePool, Mask, ModelOptions, ModelSet, ProcessMode, VisionFrame
from educationvdo.vision import conditional_match_frame_color, read_static_image, read_static_video_frame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		educationvdo.jobs.job_store.register_step_keys([ 'deep_swapper_model', 'deep_swapper_morph' ])
