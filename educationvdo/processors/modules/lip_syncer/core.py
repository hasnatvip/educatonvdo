...
from educationvdo.audio import read_static_voice
from educationvdo.common_helper import create_float_metavar, get_middle
...
from educationvdo.face_helper import create_bounding_box, paste_back, warp_face_by_bounding_box, warp_face_by_face_landmark_5
from educationvdo.face_masker import create_area_mask, create_box_mask, create_occlusion_mask
from educationvdo.face_selector import select_faces
from educationvdo.filesystem import has_audio, resolve_relative_path
from educationvdo.processors.modules.lip_syncer import choices as lip_syncer_choices
from educationvdo.processors.modules.lip_syncer.types import LipSyncerInputs, LipSyncerWeight
...
from educationvdo.types import ApplyStateItem, Args, AudioFrame, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		educationvdo.jobs.job_store.register_step_keys([ 'lip_syncer_model', 'lip_syncer_weight' ])
