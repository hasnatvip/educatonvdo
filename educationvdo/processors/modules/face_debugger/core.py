...
from educationvdo import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, logger, state_manager, translator, video_manager, voice_extractor
from educationvdo.common_helper import get_middle
from educationvdo.face_creator import scale_face
from educationvdo.face_helper import warp_face_by_face_landmark_5
...
from educationvdo.filesystem import in_directory, is_image, is_video, same_file_extension
from educationvdo.processors.modules.face_debugger import choices as face_debugger_choices
from educationvdo.processors.modules.face_debugger.types import FaceDebuggerInputs
from educationvdo.processors.types import ProcessorOutputs
from educationvdo.program_helper import find_argument_group
from educationvdo.types import ApplyStateItem, Args, Face, InferencePool, ProcessMode, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		educationvdo.jobs.job_store.register_step_keys([ 'face_debugger_items' ])
