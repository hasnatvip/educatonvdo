...
from educationvdo.common_helper import get_first, get_middle, is_macos
from educationvdo.download import conditional_download_hashes, conditional_download_sources, resolve_download_url
from educationvdo.execution import has_execution_provider
from educationvdo.face_creator import average_face_identity, get_one_face, get_static_faces, scale_face
from educationvdo.face_helper import paste_back, warp_face_by_face_landmark_5
from educationvdo.face_masker import create_area_mask, create_box_mask, create_occlusion_mask, create_region_mask
from educationvdo.face_selector import select_faces, sort_faces_by_order
from educationvdo.filesystem import filter_image_paths, has_image, in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from educationvdo.model_helper import get_static_model_initializer
from educationvdo.processors.modules.face_swapper import choices as face_swapper_choices
from educationvdo.processors.modules.face_swapper.types import FaceSwapperInputs
from educationvdo.processors.pixel_boost import explode_pixel_boost, implode_pixel_boost
from educationvdo.processors.types import ProcessorOutputs
from educationvdo.program_helper import find_argument_group
from educationvdo.thread_helper import conditional_thread_semaphore
from educationvdo.types import ApplyStateItem, Args, DownloadScope, Embedding, Face, InferencePool, InferenceProvider, ModelOptions, ModelSet, ProcessMode, VisionFrame
from educationvdo.vision import read_static_image, read_static_images, read_static_video_frame, unpack_resolution
...
def adjust_inference_providers() -> List[InferenceProvider]:
	...
	if is_macos() and has_execution_provider('coreml') and model_precision == 'fp16' and workflow_mode == 'image-to-video':
		return\
		[
			(educationvdo.choices.execution_provider_set.get('coreml'),
			{
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		educationvdo.jobs.job_store.register_step_keys([ 'face_swapper_model', 'face_swapper_pixel_boost', 'face_swapper_weight' ])
